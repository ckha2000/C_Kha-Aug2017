...
public class MiniLab{
	public static void main(String[] args){
		...
		System.out.println("The most expensive meal was $" + expensive + "!");
		 ...
		 */
		double average = averagePrice(mealPrices);
		System.out.println("The average cost of a meal was $" + average);
		...
		String[] teacherNames = {"Cotter", "Dreyer", "Price", "Williams", "Michot", "Louie"};
		System.out.println(Arrays.toString(teacherNames));
		boolean match = false;
		
		Scanner userInput = new Scanner(System.in);
		System.out.print("Please enter the last name of a teacher: ");
		...
		if(match){
			System.out.println("Yay, I have " + tempName + " too!");
		}else{
			System.out.println("I don't have " + tempName);
		}
		...
		String[] tempTeachers = new String[length];
		
		for(int i = 0; i < length; i++){
			System.out.println("Enter teacher #" + (i+1) + ": ");
			tempTeachers[i] = userInput.next();
		}
		
		userInput.close();
		System.out.println();
		
		teacherCompare(teacherNames, tempTeachers);
		
	}

	public static void teacherCompare(String[] mine, String[] yours){
		Arrays.sort(mine);
		Arrays.sort(yours);
	...
	public static double averagePrice(double[] arr){
		double sum = 0;
